...
public class W_ForecastNight {
	...
	public String getLg_daypart_name() {
		return lg_daypart_name;
	}
	public void setLg_daypart_name(String lg_daypart_name) {
		this.lg_daypart_name = lg_daypart_name;
	}
